...
from models import MyNetwork, DomainClassifier
...
parser.add_argument('--episodes', default=2000, type=int, help='(2000) Number of total episodes to run')
...
parser.add_argument('--loss_hard_weight', default=5.0, type=float, help='Important! Weight for triplet loss')
...
criterion_hard = KernalTripletHardLoss(margin=args.loss_hard_margin).cuda()
